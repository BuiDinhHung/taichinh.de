      ...
      <div className="relative">
        ...
        <div className="absolute inset-0">
          <div className="dvag-container relative h-full">
            <div
              className="absolute bottom-0 left-0 right-0 bg-brand-gold/94 p-6 text-white shadow-[0_22px_48px_rgba(0,0,0,0.18)] sm:p-8 md:bottom-12 md:right-auto md:max-w-md md:p-10
                         md:[clip-path:polygon(0_0,100%_0,92%_100%,0_100%)] md:pr-16"
            >
              <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-white/95">
