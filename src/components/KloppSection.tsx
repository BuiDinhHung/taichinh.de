      ...
      <div className="relative">
        ...
        <div className="absolute inset-0">
          <div className="dvag-container relative h-full">
            <div
              className="absolute bottom-0 left-0 right-0 bg-brand-gold p-6 text-white sm:p-8 md:bottom-12 md:right-auto md:max-w-md md:p-10
            ...
            >
              ...
              <h2 className="mt-3 text-2xl sm:text-3xl lg:text-[34px] leading-[1.15] font-bold text-white">
