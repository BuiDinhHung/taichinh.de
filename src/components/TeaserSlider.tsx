      ...
      <div className="dvag-container">
        ...
        >
          {teaserCards.map((card) => (
            <article
              key={card.headline}
              className="tc-card group relative flex shrink-0 basis-[82%] flex-col overflow-hidden rounded-lg min-[420px]:basis-[74%] sm:basis-[56%] md:basis-auto"
            >
              ...
              <div className="p-5">
                <Link
                  href={card.cta.href}
                  className="tc-button-secondary gap-2 px-4 py-2.5 text-sm"
                >
                  {card.cta.label}
